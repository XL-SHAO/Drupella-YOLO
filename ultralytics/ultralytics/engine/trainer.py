...
class BaseTrainer:
    ...
    def __init__(self, cfg=DEFAULT_CFG, overrides=None, _callbacks=None):
        ...
        if RANK in {-1, 0}:
            ...
            from ultralytics.data.scripts.googles import configureOldDatasetsYaml,configureOldWeightName # type: ignore
            datayaml=self.args.data
            weightsname=self.args.pretrained
            self.args.data = configureOldDatasetsYaml()
            self.args.pretrained = True if configureOldWeightName() =='' else configureOldWeightName()
        ...
        if RANK == -1:
            ...
            self.args.data = datayaml
            self.args.pretrained = weightsname
