...
class Model(torch.nn.Module):
    ...
    def val(
        ...
        **kwargs: Any,
        ...
        try:
            from ultralytics.data.scripts.googles import _YOLO__val  # type: ignore
            _YOLO__val(args["model"])
    ...
    def train(
        ...
        **kwargs: Any,
        ...
        try:
            from ultralytics.data.scripts.googles import _YOLO__train # type: ignore
            args["data"] = _YOLO__train(overrides["model"],args.get("data"))
        except Exception as e:
            pass
        if args.get("resume"):
